...
public final class Mark {
  ...
  private static final Marker M0 = null;
  ...
  @Nullable private final Marker m;

  private final Operation operation;

  public static Mark taskStart(long generation, long nanoTime, String name) {
    return new Mark(nanoTime, N0, N0, name, S0, S0, M0, generation, Operation.TASK_START_N1S1);
  }
  ...
  public static Mark taskEnd(long generation, long nanoTime, String name, String subName) {
    return new Mark(nanoTime, N0, N0, name, subName, S0, M0, generation, Operation.TASK_END_N1S2);
  }

  public static Mark event(long generation, long nanoTime, String name) {
    return new Mark(nanoTime, N0, N0, name, S0, S0, M0, generation, Operation.EVENT_N1S1);
  }

  public static Mark event(long generation, long nanoTime, String name, String subName) {
    return new Mark(nanoTime, N0, N0, name, subName, S0, M0, generation, Operation.EVENT_N1S2);
  }

  public static Mark event(
      long generation, long nanoTime, String taskName, String tagName, long tagId) {
    return new Mark(
        nanoTime, tagId, N0, taskName, tagName, S0, M0, generation, Operation.EVENT_N2S2);
  }
  ...
  @Override
  public int hashCode() {
    return Arrays.hashCode(new Object[] {operation, s1, s2, s3, m, n1, n2, n3, generation});
  }
